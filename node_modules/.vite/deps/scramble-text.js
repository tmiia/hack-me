// node_modules/scramble-text/dist/ScrambleText.module.js
...
var ScrambleText = function() {
  function ScrambleText2(el) {
    var option = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    _classCallCheck(this, ScrambleText2);
    this._startTime = 0;
    this._elapsedTime = 0;
    this._running = false;
    this._idling = true;
  ...
  ScrambleText2.prototype.play = function play() {
  ...
  ScrambleText2.prototype.start = function start() {
    this._idling = false;
  ...
  ScrambleText2.prototype.stop = function stop() {
    this._running = false;
    this.el.removeAttribute(ATTR_IDLING);
    this.el.removeAttribute(ATTR_RUNNING);
    return this;
  };
  return ScrambleText2;
}();
function anim() {
  var elapsedTime = Date.now() - this._startTime;
  var deltaTime = elapsedTime - this._elapsedTime;
  var needsUpdate = 1e3 / this.fps <= deltaTime;
  if (!needsUpdate) {
...
var ScrambleText_module_default = ScrambleText;
export {
  ScrambleText_module_default as default
};
/*! Bundled license information:

scramble-text/dist/ScrambleText.module.js:
  (*!
   * ScrambleText
